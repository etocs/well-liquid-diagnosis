...
export const wells: Well[] = [
  { id: 'W001', name: '乌石17-2-A3-01', platform: '乌石17-2平台', pumpName: 'ESP-A3-01', status: 'normal', liquidHeight: 0 },
  { id: 'W002', name: '乌石17-2-A3-02', platform: '乌石17-2平台', pumpName: 'ESP-A3-02', status: 'warning', liquidHeight: 320 },
  { id: 'W003', name: '乌石17-2-A43-01', platform: '乌石17-2平台', pumpName: 'ESP-A43-01', status: 'fault', liquidHeight: 850 },
  { id: 'W004', name: '乌石17-2-B1-01', platform: '乌石17-2平台', pumpName: 'ESP-B1-01', status: 'normal', liquidHeight: 0 },
  { id: 'W005', name: '乌石17-2-B2-01', platform: '乌石17-2平台', pumpName: 'ESP-B2-01', status: 'warning', liquidHeight: 150 },
  { id: 'W006', name: '乌石23-5-C1-01', platform: '乌石23-5平台', pumpName: 'ESP-C1-01', status: 'normal', liquidHeight: 0 },
  { id: 'W007', name: '乌石23-5-C2-01', platform: '乌石23-5平台', pumpName: 'ESP-C2-01', status: 'fault', liquidHeight: 1200 },
];

// ============ 故障预警数据 ============
export const alarmRecords: AlarmRecord[] = [
  {
    id: 'A001', wellId: 'W003', wellName: '乌石17-2-A43-01', platform: '乌石17-2平台',
    pumpName: 'ESP-A43-01', faultType: '积液', faultLevel: 'level1',
  ...
  {
    id: 'A002', wellId: 'W002', wellName: '乌石17-2-A3-02', platform: '乌石17-2平台',
    pumpName: 'ESP-A3-02', faultType: '含气', faultLevel: 'level2',
    faultTime: '2026-03-09 05:15:00', processResult: 'unprocessed',
    faultReason: '电流波动幅度超过正常范围20%，疑似泵入口含气量较高',
    faultRange: '2026-03-09 04:45:00 ~ 2026-03-09 05:15:00',
  },
  {
    id: 'A003', wellId: 'W005', wellName: '乌石17-2-B2-01', platform: '乌石17-2平台',
    pumpName: 'ESP-B2-01', faultType: '欠载', faultLevel: 'level2',
    faultTime: '2026-03-09 03:20:00', processResult: 'processed', processTime: '2026-03-09 04:00:00',
    faultReason: '电机负载低于额定值，可能存在少量积液或地层液量减少',
    faultRange: '2026-03-09 03:00:00 ~ 2026-03-09 03:20:00',
  },
  {
    id: 'A004', wellId: 'W007', wellName: '乌石23-5-C2-01', platform: '乌石23-5平台',
    pumpName: 'ESP-C2-01', faultType: '积液', faultLevel: 'level1',
  ...
  {
    id: 'A005', wellId: 'W001', wellName: '乌石17-2-A3-01', platform: '乌石17-2平台',
    pumpName: 'ESP-A3-01', faultType: '高温', faultLevel: 'level3',
    faultTime: '2026-03-08 18:45:00', processResult: 'processed', processTime: '2026-03-08 19:30:00',
    faultReason: '电机绕组温度略高于正常值，已处理冷却系统，温度恢复正常',
    faultRange: '2026-03-08 18:30:00 ~ 2026-03-08 18:45:00',
  },
  {
    id: 'A006', wellId: 'W004', wellName: '乌石17-2-B1-01', platform: '乌石17-2平台',
    pumpName: 'ESP-B1-01', faultType: '过载', faultLevel: 'level2',
    faultTime: '2026-03-08 15:00:00', processResult: 'processed', processTime: '2026-03-08 16:00:00',
    faultReason: '电流超过额定值15%，电机过载运行，已调整变频器频率',
    faultRange: '2026-03-08 14:30:00 ~ 2026-03-08 15:00:00',
  },
  {
    id: 'A007', wellId: 'W006', wellName: '乌石23-5-C1-01', platform: '乌石23-5平台',
    pumpName: 'ESP-C1-01', faultType: '绝缘降低', faultLevel: 'level3',
  ...
  {
    id: 'A008', wellId: 'W002', wellName: '乌石17-2-A3-02', platform: '乌石17-2平台',
    pumpName: 'ESP-A3-02', faultType: '积液', faultLevel: 'level2',
